...
public class WebSecurityConfig  {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.antMatchers("/admin/getAllSchemes").permitAll()
		.antMatchers("/admin/**").hasRole("SARPANCH")
		.antMatchers("/member/**").hasRole("MEMBERS")
		.antMatchers("/", "/login","/register","/auth/**").permitAll() // enabling global
								// access to all
								// urls with
								// /auth
